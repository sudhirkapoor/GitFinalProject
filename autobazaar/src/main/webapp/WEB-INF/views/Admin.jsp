...
<div>
	...
	<div class="container central">
		...
		<c:url var="addAction" value="/Admin/addProduct" />
			...
			<form:form class="form-signin" action="${addAction}" commandName="product" method="post">
				...
				<table >
					<c:if test="${!empty product.pname}">
						<tr>
							...
							<td><form:input path="pid" readonly="true" style="width:150px;" size="8"
					...
					<tr>
						...
						<td><form:input path="pname" style="width:150px;" class="form-control"  />
							<form:errors path="pname" /></td>
					</tr>
					<tr>
						<td><form:label path="pbrand">
								<spring:message text="Product Brand" />
							</form:label></td>
						<td><form:input path="pbrand" style="width:150px;" class="form-control" />
							<form:errors path="pbrand" /></td>
					</tr>
					<tr>
						<td><form:label path="pdescription">
								<spring:message text="Product Description" />
							</form:label></td>
						<td><form:input path="pdescription" style="width:150px;" class="form-control" />
							<form:errors path="pdescription" /></td>
					</tr>
					...
					<tr>
						...
						<td><form:input path="pprice" style="width:150px;" class="form-control" />
							<form:errors path="pprice" /></td>
					</tr>
					...
					<tr>
						...
						<td><form:input path="pcategory" class="form-control col-xs-2" style="width:150px;" />
							<form:errors path="pcategory" /></td>
					</tr>

					<tr >
						<td colspan="2" style="align:center"><c:if test="${!empty product.pname}">
